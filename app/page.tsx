  ...
  return (
    <Fragment>
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-16 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-dark-card border border-dark-border mb-8 animate-float">
            ...
            <span className="text-sm font-semibold text-gray-300">AI-Powered Golf Technology</span>
          </div>
      ...
      <section className="py-32 bg-dark-bg relative overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_70%_30%,rgba(34,197,94,0.06),transparent_60%)]"></div>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary-500/20 rounded-full mb-6">
              <span className="text-xl">🧠</span>
              <span className="text-primary-400 font-bold text-sm">AI-POWERED</span>
            </div>
            <h2 className="text-6xl md:text-7xl font-black mb-6">
              <span className="text-white">AI Isn&apos;t the Future.</span>
              <br />
              <span className="text-primary-400">It&apos;s Already Here.</span>
            </h2>
            <p className="text-xl text-gray-400 max-w-3xl mx-auto leading-relaxed">
              Every product we build has artificial intelligence baked into its DNA. Not as a buzzword — as the engine.
              We&apos;re using AI to move golf technology forward in ways the industry hasn&apos;t seen.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <div className="group bg-dark-card border border-dark-border rounded-2xl p-8 hover:border-primary-500 transition-all hover:shadow-2xl hover:shadow-primary-500/20 text-center">
              ...
              <h3 className="text-2xl font-black text-white mb-3">Voice AI</h3>
              <p className="text-gray-400 leading-relaxed">
                Our AI voice agent answers the phone, books tee times, and handles customer inquiries around the clock.
                <span className="text-white font-semibold"> No hold music. No missed revenue. 24/7.</span>
              </p>
            </div>
            ...
            <div className="group bg-dark-card border border-dark-border rounded-2xl p-8 hover:border-primary-500 transition-all hover:shadow-2xl hover:shadow-primary-500/20 text-center">
              ...
              <h3 className="text-2xl font-black text-white mb-3">Smart Game Engine</h3>
              <p className="text-gray-400 leading-relaxed">
                Real-time scoring, payout calculations, handicap adjustments, and leaderboard intelligence across every format.
                <span className="text-white font-semibold"> The math is instant. The experience is seamless.</span>
              </p>
            </div>
            ...
            <div className="group bg-dark-card border border-dark-border rounded-2xl p-8 hover:border-primary-500 transition-all hover:shadow-2xl hover:shadow-primary-500/20 text-center">
              ...
              <h3 className="text-2xl font-black text-white mb-3">Automation at Scale</h3>
              <p className="text-gray-400 leading-relaxed">
                From team balancing to SMS notifications to tournament operations — AI handles the tedious stuff so you don&apos;t have to.
                <span className="text-white font-semibold"> Less busywork. More golf.</span>
              </p>
            </div>
          </div>
          ...
          <div className="text-center mt-16">
            <p className="text-lg text-gray-500 italic max-w-2xl mx-auto">
              &ldquo;Golf tech has been stuck in 2005 for twenty years. We&apos;re building what comes next — and AI is how we get there.&rdquo;
            </p>
          </div>
        </div>
      </section>
